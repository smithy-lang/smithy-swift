...
public struct MockHandler<Output: HttpResponseBinding, OutputError: HttpResponseBinding>: Handler {
    ...
    public typealias MockHandlerCallback = (Context, SdkHttpRequest) -> Result<OperationOutput<Output,
                                                                                               OutputError>,
                                                                               Error>
    ...
    public func handle(context: Context, input: SdkHttpRequest) -> Result<OperationOutput<Output,
                                                                                          OutputError>,
                                                                          Error> {
