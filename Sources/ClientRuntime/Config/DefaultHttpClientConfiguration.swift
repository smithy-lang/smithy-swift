...
public protocol DefaultHttpClientConfiguration: ClientConfiguration {
    ...
    var httpClientEngine: HTTPClient { get }
    ...
    var authSchemes: [AuthScheme]? { get }
    ...
    var authSchemeResolver: AuthSchemeResolver { get }
    ...
    var bearerTokenIdentityResolver: any BearerTokenIdentityResolver { get }
