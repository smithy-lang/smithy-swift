...
> {
    ...
    public mutating func add(
        _ interceptor: any Interceptor<InputType, OutputType, RequestType, ResponseType>
    ) {
    ...
    /// - Parameter interceptor: The Interceptor to add.
    public mutating func add(
        _ interceptor: some Interceptor<InputType, OutputType, RequestType, ResponseType>
    ) {
        self.interceptors.append(interceptor.erase())
    }
    ...
    public mutating func addReadBeforeExecution(
        _ interceptorFn: @escaping (any BeforeSerialization<InputType>) async throws -> Void
    ) {
    ...
    public mutating func addModifyBeforeSerialization(
        _ interceptorFn: @escaping (any MutableInput<InputType>) async throws -> Void
    ) {
    ...
    public mutating func addReadAfterSerialization(
        _ interceptorFn: @escaping (any AfterSerialization<InputType, RequestType>) async throws -> Void
    ) {
    ...
    public mutating func addModifyBeforeRetryLoop(
        _ interceptorFn: @escaping (any MutableRequest<InputType, RequestType>) async throws -> Void
    ) {
    ...
    public mutating func addReadAfterTransmit(
        _ interceptorFn: @escaping (any BeforeDeserialization<InputType, RequestType, ResponseType>)
            async throws -> Void
    ) {
    ...
    public mutating func addModifyBeforeDeserialization(
        _ interceptorFn: @escaping (any MutableResponse<InputType, RequestType, ResponseType>)
            async throws -> Void
    ) {
    ...
    public mutating func addReadAfterDeserialization(
        _ interceptorFn: @escaping (
            any AfterDeserialization<InputType, OutputType, RequestType, ResponseType>
        )
            async throws -> Void
    ) {
    ...
    public mutating func addModifyBeforeAttemptCompletion(
        _ interceptorFn: @escaping (
            any MutableOutputAfterAttempt<InputType, OutputType, RequestType, ResponseType>
        )
            async throws -> Void
    ) {
    ...
    public mutating func addReadAfterAttempt(
        _ interceptorFn: @escaping (any AfterAttempt<InputType, OutputType, RequestType, ResponseType>)
            async throws -> Void
    ) {
    ...
    public mutating func addModifyBeforeCompletion(
        _ interceptorFn: @escaping (
            any MutableOutputFinalization<InputType, OutputType, RequestType, ResponseType>
        ) async throws -> Void
    ) {
    ...
    public mutating func addReadAfterExecution(
        _ interceptorFn: @escaping (any Finalization<InputType, OutputType, RequestType, ResponseType>)
            async throws -> Void
    ) {
