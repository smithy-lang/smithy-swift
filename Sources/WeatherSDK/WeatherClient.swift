...
public class WeatherClient: Client {
    ...
    let config: WeatherClient.WeatherConfiguration
    let serviceName = "Weather"
    let encoder: ClientRuntime.RequestEncoder
    let decoder: ClientRuntime.ResponseDecoder

    public required init(config: WeatherClient.WeatherConfiguration) {
    ...
    public convenience required init() throws {
        let config = try WeatherClient.WeatherConfiguration()
...
extension WeatherClient {
    public class WeatherConfiguration: DefaultClientConfiguration & DefaultHttpClientConfiguration {
        ...
        public convenience required init() async throws {
            try await self.init(logger: nil, retryStrategyOptions: nil, clientLogMode: nil, endpoint: nil, idempotencyTokenGenerator: nil, httpClientEngine: nil, httpClientConfiguration: nil, authSchemes: nil, authSchemeResolver: nil)
        }
