...
public struct MockSerializeMiddleware {
    public typealias MockSerializeMiddlewareCallback = (MockInput, SdkHttpRequestBuilder, Context) -> Void
...
extension MockSerializeMiddleware: RequestMessageSerializer {
    ...
    public func apply(input: MockInput, builder: SmithyHTTPAPI.SdkHttpRequestBuilder, attributes: Smithy.Context) throws {
