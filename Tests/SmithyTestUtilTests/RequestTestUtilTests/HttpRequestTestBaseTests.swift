...
class HttpRequestTestBaseTests: HttpRequestTestBase {
    ...
    public struct SayHelloInputURLHostMiddleware: RequestMessageSerializer {
        ...
        public func apply(input: SayHelloInput, builder: SdkHttpRequestBuilder, attributes: Context) throws {
            if let host = host {
    ...
    struct SayHelloInputQueryItemMiddleware: RequestMessageSerializer {
        ...
        public func apply(input: HttpRequestTestBaseTests.SayHelloInput, builder: SdkHttpRequestBuilder, attributes: Context) throws {
