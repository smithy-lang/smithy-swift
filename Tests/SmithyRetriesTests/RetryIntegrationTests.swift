...
final class RetryIntegrationTests: XCTestCase {
    ...
    private var builder: OrchestratorBuilder<TestInput, TestOutputResponse, SdkHttpRequest, HttpResponse>!
...
private class TestOutputHandler: ExecuteRequest {
    typealias RequestType = SdkHttpRequest
    ...
    func execute(request: SmithyHTTPAPI.SdkHttpRequest, attributes: Smithy.Context) async throws -> SmithyHTTPAPI.HttpResponse {
    ...
    func verifyInput(input: SdkHttpRequest) async throws {
