...
class RetryMiddleware(
    ...
    override fun render(writer: SwiftWriter, op: OperationShape, operationStackName: String) {
        ...
        writer.write("$operationStackName.${middlewareStep.stringValue()}.intercept(position: ${position.stringValue()}, middleware: \$N<\$N, \$N>(${middlewareParamsString()}))", ClientRuntimeTypes.Middleware.RetryerMiddleware, output, outputError)
    }
