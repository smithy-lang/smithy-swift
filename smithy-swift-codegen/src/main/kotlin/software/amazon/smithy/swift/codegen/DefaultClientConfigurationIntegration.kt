...
import software.amazon.smithy.swift.codegen.config.EndpointClientConfiguration
...
class DefaultClientConfigurationIntegration : SwiftIntegration {
    override fun clientConfigurations(ctx: ProtocolGenerator.GenerationContext): List<ClientConfiguration> {
        return listOf(DefaultClientConfiguration(), DefaultHttpClientConfiguration(), EndpointClientConfiguration(ctx))
    }
}
