...
class OperationEndpointResolverMiddleware(
    ...
    override fun render(ctx: ProtocolGenerator.GenerationContext, writer: SwiftWriter, op: OperationShape, operationStackName: String) {
        ...
        writer.write(
            "$operationStackName.${middlewareStep.stringValue()}.intercept(position: ${position.stringValue()}, middleware: \$N<\$N>($middlewareParamsString))",
            EndpointSymbols.EndpointResolverMiddleware, output
        )
    }
