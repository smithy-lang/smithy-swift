...
fun SwiftWriter.appendWithDelimiter(previousText: Any?, text: String, delimiter: String = ", ") {
    when {
...
class SwiftWriter(private val fullPackageName: String, importDeclarations: ImportDeclarations = ImportDeclarations()) :
    SymbolWriter<SwiftWriter, ImportDeclarations>(importDeclarations) {

    private val imports: ImportDeclarations
    internal val dependencies: MutableList<SymbolDependency>

    companion object {
        val staticHeader: String = "// Code generated by smithy-swift-codegen. DO NOT EDIT!\n\n"
    }

    public class SwiftWriterFactory(private val integrations: List<SwiftIntegration> = listOf()) : Factory<SwiftWriter> {
        override fun apply(filename: String, namespace: String?): SwiftWriter {

            val moduleName = if (filename.endsWith(".swift")) filename.substring(0, filename.length - 6) else filename
