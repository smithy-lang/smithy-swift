...
class ServiceGeneratorTests {
    ...
    fun `it renders swift func signatures correctly`() {
        val expectedSignatures = listOf(
            "func getFooStreamingInput(input: GetFooStreamingInputInput, streamSource: StreamSource, completion: @escaping (SdkResult<GetFooStreamingInputOutput, GetFooStreamingInputOutputError>) -> Void)",
            "func getFooNoOutput(input: GetFooNoOutputInput, completion: @escaping (SdkResult<GetFooNoOutputOutput, GetFooNoOutputOutputError>) -> Void)",
            "func getFooStreamingOutput(input: GetFooStreamingOutputInput, streamSink: StreamSink, completion: @escaping (SdkResult<GetFooStreamingOutputOutput, GetFooStreamingOutputOutputError>) -> Void)",
            "func getFoo(input: GetFooInput, completion: @escaping (SdkResult<GetFooOutput, GetFooOutputError>) -> Void)",
            "func getFooNoInput(input: GetFooNoInputInput, completion: @escaping (SdkResult<GetFooNoInputOutput, GetFooNoInputOutputError>) -> Void)",
            "func getFooStreamingInputNoOutput(input: GetFooStreamingInputNoOutputInput, streamSource: StreamSource, completion: @escaping (SdkResult<GetFooStreamingInputNoOutputOutput, GetFooStreamingInputNoOutputOutputError>) -> Void)",
            "func getFooStreamingOutputNoInput(input: GetFooStreamingOutputNoInputInput, streamSink: StreamSink, completion: @escaping (SdkResult<GetFooStreamingOutputNoInputOutput, GetFooStreamingOutputNoInputOutputError>) -> Void)"
        )
