...
class HttpProtocolUnitTestRequestGeneratorTests {
    ...
    func testSmokeTest() async throws {
        ...
        operationStack.finalizeStep.intercept(position: .before, middleware: ClientRuntime.SignerMiddleware<SmokeTestOutput>())
...
"""
    ...
    func testExplicitString() async throws {
        ...
        operationStack.finalizeStep.intercept(position: .before, middleware: ClientRuntime.ContentLengthMiddleware())
        operationStack.finalizeStep.intercept(position: .before, middleware: ClientRuntime.SignerMiddleware<ExplicitStringOutput>())
        operationStack.deserializeStep.intercept(
            position: .after,
...
"""
    ...
    func testRestJsonEmptyInputAndEmptyOutput() async throws {
        ...
        operationStack.finalizeStep.intercept(position: .before, middleware: ClientRuntime.SignerMiddleware<EmptyInputAndEmptyOutputOutput>())
        operationStack.deserializeStep.intercept(
            position: .after,
...
"""
    ...
    func testRestJsonDoesntSerializeNullStructureValues() async throws {
        ...
        operationStack.finalizeStep.intercept(position: .before, middleware: ClientRuntime.ContentLengthMiddleware())
        operationStack.finalizeStep.intercept(position: .before, middleware: ClientRuntime.SignerMiddleware<SimpleScalarPropertiesOutput>())
        operationStack.deserializeStep.intercept(
            position: .after,
...
"""
    ...
    func testRestJsonStreamingTraitsWithBlob() async throws {
        ...
        operationStack.finalizeStep.intercept(position: .before, middleware: ClientRuntime.ContentLengthMiddleware())
        operationStack.finalizeStep.intercept(position: .before, middleware: ClientRuntime.SignerMiddleware<StreamingTraitsOutput>())
        operationStack.deserializeStep.intercept(
            position: .after,
...
"""
    ...
    func testRestJsonHttpPrefixHeadersAreNotPresent() async throws {
        ...
        operationStack.finalizeStep.intercept(position: .before, middleware: ClientRuntime.SignerMiddleware<HttpPrefixHeadersOutput>())
        operationStack.deserializeStep.intercept(
            position: .after,
...
"""
    ...
    func testRestJsonSerializeStringUnionValue() async throws {
        ...
        operationStack.finalizeStep.intercept(position: .before, middleware: ClientRuntime.ContentLengthMiddleware())
        operationStack.finalizeStep.intercept(position: .before, middleware: ClientRuntime.SignerMiddleware<JsonUnionsOutput>())
        operationStack.deserializeStep.intercept(
            position: .after,
...
"""
    ...
    func testRestJsonRecursiveShapes() async throws {
        ...
        operationStack.finalizeStep.intercept(position: .before, middleware: ClientRuntime.ContentLengthMiddleware())
        operationStack.finalizeStep.intercept(position: .before, middleware: ClientRuntime.SignerMiddleware<RecursiveShapesOutput>())
        operationStack.deserializeStep.intercept(
            position: .after,
...
"""
    ...
    func testInlineDocumentInput() async throws {
        ...
        let input = InlineDocumentInput(
            ...
            operationStack.finalizeStep.intercept(position: .before, middleware: ClientRuntime.ContentLengthMiddleware())
            operationStack.finalizeStep.intercept(position: .before, middleware: ClientRuntime.SignerMiddleware<InlineDocumentOutput>())
            operationStack.deserializeStep.intercept(
                position: .after,
...
"""
    ...
    func testInlineDocumentAsPayloadInput() async throws {
        ...
        let input = InlineDocumentAsPayloadInput(
            ...
            operationStack.finalizeStep.intercept(position: .before, middleware: ClientRuntime.ContentLengthMiddleware())
            operationStack.finalizeStep.intercept(position: .before, middleware: ClientRuntime.SignerMiddleware<InlineDocumentAsPayloadOutput>())
            operationStack.deserializeStep.intercept(
                position: .after,
