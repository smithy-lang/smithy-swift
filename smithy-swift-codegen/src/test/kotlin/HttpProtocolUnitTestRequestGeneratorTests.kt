...
class HttpProtocolUnitTestRequestGeneratorTests {
    ...
    func testSmokeTest() {
        ...
        let context = HttpContextBuilder()
                      ...
                      .build()
        let operationStack = OperationStack<SmokeTestInput, SmokeTestOutput, SmokeTestError>(id: "SmokeTest")
...
"""
    ...
    func testExplicitString() {
        ...
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      .build()
        let operationStack = OperationStack<ExplicitStringInput, ExplicitStringOutput, ExplicitStringError>(id: "ExplicitString")
...
"""
    ...
    func testRestJsonEmptyInputAndEmptyOutput() {
        ...
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      .build()
        let operationStack = OperationStack<EmptyInputAndEmptyOutputInput, EmptyInputAndEmptyOutputOutput, EmptyInputAndEmptyOutputError>(id: "RestJsonEmptyInputAndEmptyOutput")
...
"""
    ...
    func testRestJsonDoesntSerializeNullStructureValues() {
        ...
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      .build()
        let operationStack = OperationStack<SimpleScalarPropertiesInput, SimpleScalarPropertiesOutput, SimpleScalarPropertiesError>(id: "RestJsonDoesntSerializeNullStructureValues")
...
"""
    ...
    func testRestJsonStreamingTraitsWithBlob() {
        ...
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      .build()
        let operationStack = OperationStack<StreamingTraitsInput, StreamingTraitsOutput, StreamingTraitsError>(id: "RestJsonStreamingTraitsWithBlob")
...
"""
    ...
    func testRestJsonHttpPrefixHeadersAreNotPresent() {
        ...
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      .build()
        let operationStack = OperationStack<HttpPrefixHeadersInput, HttpPrefixHeadersOutput, HttpPrefixHeadersError>(id: "RestJsonHttpPrefixHeadersAreNotPresent")
...
"""
    ...
    func testRestJsonSerializeStringUnionValue() {
        ...
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      .build()
        let operationStack = OperationStack<JsonUnionsInput, JsonUnionsOutput, JsonUnionsError>(id: "RestJsonSerializeStringUnionValue")
...
"""
    ...
    func testRestJsonRecursiveShapes() {
        ...
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      .build()
        let operationStack = OperationStack<RecursiveShapesInput, RecursiveShapesOutput, RecursiveShapesError>(id: "RestJsonRecursiveShapes")
 ...
 """
    ...
    func testInlineDocumentInput() {
        ...
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      .build()
        let operationStack = OperationStack<InlineDocumentInput, InlineDocumentOutput, InlineDocumentError>(id: "InlineDocumentInput")
 ...
 """
    ...
    func testInlineDocumentAsPayloadInput() {
        ...
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      .build()
        let operationStack = OperationStack<InlineDocumentAsPayloadInput, InlineDocumentAsPayloadOutput, InlineDocumentAsPayloadError>(id: "InlineDocumentAsPayloadInput")
