...
class StructEncodeXMLGenerationTests {
    ...
    fun `simpleScalar serialization`() {
        ...
        val contents = getFileContents(context.manifest, "RestXml/Sources/RestXml/models/SimpleScalarPropertiesInput+Write.swift")
...
"""
    ...
    fun `008 structure xmlName`() {
        ...
        val contents = getFileContents(context.manifest, "RestXml/Sources/RestXml/models/StructureListMember+ReadWrite.swift")
        val expectedContents = """
