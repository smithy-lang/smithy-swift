...
class ReservedWordsGeneratorTests {
    ...
    fun `test enum`() {
        ...
        val contents = getFileContents(context.manifest, "example/Sources/example/models/ReservedWordsEnum.swift")
...
"""
    ...
    fun `it handles type name that conflicts with swift metatype`() {
        val context = setupTests("reserved-name-enum-test.smithy", "com.test#Example")
        val contents = getFileContents(context.manifest, "example/Sources/example/models/Type.swift")
        val expectedContents = """
extension ExampleClientTypes {
...
"""
    ...
    fun `it handles protocol name that conflicts with swift metatype`() {
        val context = setupTests("reserved-name-enum-test.smithy", "com.test#Example")
        val contents = getFileContents(context.manifest, "example/Sources/example/models/Protocol.swift")
        val expectedContents = """
extension ExampleClientTypes {
