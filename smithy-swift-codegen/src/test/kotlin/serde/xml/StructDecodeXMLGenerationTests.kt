        ...
        extension XmlWrappedListOutputResponseBody: Swift.Decodable {
            ...
            public init (from decoder: Swift.Decoder) throws {
                ...
                if containerValues.contains(.myGroceryList) {
                    ...
                    let myGroceryListWrappedContainer = containerValues.nestedContainerNonThrowable(keyedBy: XMLRuntime.CollectionMemberCodingKey<KeyVal0.member>.CodingKeys.self, forKey: .myGroceryList)
        ...
        extension XmlNestedNestedWrappedListOutputResponseBody: Swift.Decodable {
            ...
            public init (from decoder: Swift.Decoder) throws {
                ...
                if containerValues.contains(.nestedNestedStringList) {
                    struct KeyVal0{struct member{}}
                    let nestedNestedStringListWrappedContainer = containerValues.nestedContainerNonThrowable(keyedBy: XMLRuntime.CollectionMemberCodingKey<KeyVal0.member>.CodingKeys.self, forKey: .nestedNestedStringList)
            ...
            extension XmlEmptyListsOutputResponseBody: Swift.Decodable {
                ...
                public init (from decoder: Swift.Decoder) throws {
                    ...
                    if containerValues.contains(.stringSet) {
                        struct KeyVal0{struct member{}}
                        let stringSetWrappedContainer = containerValues.nestedContainerNonThrowable(keyedBy: XMLRuntime.CollectionMemberCodingKey<KeyVal0.member>.CodingKeys.self, forKey: .stringSet)
