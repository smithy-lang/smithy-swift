...
"""
    ...
    public func allocateWidget(input: AllocateWidgetInput) async throws -> AllocateWidgetOutput {
        ...
        operation.serializeStep.intercept(position: .after, middleware: ClientRuntime.BodyMiddleware<AllocateWidgetInput, AllocateWidgetOutput, SmithyJSON.Writer>(documentWritingClosure: SmithyReadWrite.documentWritingClosure(rootNodeInfo: ""), inputWritingClosure: AllocateWidgetInput.write(value:to:)))
        ...
        operation.deserializeStep.intercept(position: .after, middleware: ClientRuntime.DeserializeMiddleware<AllocateWidgetOutput>(wireResponseOutputClosure(AllocateWidgetOutput.httpBinding, wireResponseDocumentBinding()), wireResponseErrorClosure(AllocateWidgetOutputError.httpErrorBinding, wireResponseDocumentBinding())))
...
"""
    ...
    public func unsignedFooBlobStream(input: UnsignedFooBlobStreamInput) async throws -> UnsignedFooBlobStreamOutput {
        ...
        operation.serializeStep.intercept(position: .after, middleware: ClientRuntime.BodyMiddleware<UnsignedFooBlobStreamInput, UnsignedFooBlobStreamOutput, SmithyJSON.Writer>(documentWritingClosure: SmithyReadWrite.documentWritingClosure(rootNodeInfo: ""), inputWritingClosure: UnsignedFooBlobStreamInput.write(value:to:)))
        ...
        operation.deserializeStep.intercept(position: .after, middleware: ClientRuntime.DeserializeMiddleware<UnsignedFooBlobStreamOutput>(wireResponseOutputClosure(UnsignedFooBlobStreamOutput.httpBinding, wireResponseDocumentBinding()), wireResponseErrorClosure(UnsignedFooBlobStreamOutputError.httpErrorBinding, wireResponseDocumentBinding())))
...
"""
    ...
    public func explicitBlobStreamWithLength(input: ExplicitBlobStreamWithLengthInput) async throws -> ExplicitBlobStreamWithLengthOutput {
        ...
        operation.deserializeStep.intercept(position: .after, middleware: ClientRuntime.DeserializeMiddleware<ExplicitBlobStreamWithLengthOutput>(wireResponseOutputClosure(ExplicitBlobStreamWithLengthOutput.httpBinding, wireResponseDocumentBinding()), wireResponseErrorClosure(ExplicitBlobStreamWithLengthOutputError.httpErrorBinding, wireResponseDocumentBinding())))
...
"""
    ...
    public func unsignedFooBlobStreamWithLength(input: UnsignedFooBlobStreamWithLengthInput) async throws -> UnsignedFooBlobStreamWithLengthOutput {
        ...
        operation.deserializeStep.intercept(position: .after, middleware: ClientRuntime.DeserializeMiddleware<UnsignedFooBlobStreamWithLengthOutput>(wireResponseOutputClosure(UnsignedFooBlobStreamWithLengthOutput.httpBinding, wireResponseDocumentBinding()), wireResponseErrorClosure(UnsignedFooBlobStreamWithLengthOutputError.httpErrorBinding, wireResponseDocumentBinding())))
