...
//                    "                                completion(.failure(SdkError<OperationError>.client(ClientError.dataNotFound(\"No data was returned to deserialize\"))))\n" +
//                    "                            }\n" +
...
//                    "                    }\n" +
//                    "                    else {\n" +
//                    "                        completion(.failure(SdkError<OperationError>.service(ClientError.networkError(\"service error\") as! OperationError)))\n" +
//                    "                    }\n" +
//                    "\n" +
//                    "            }\n" +
//                    "        }\n" +
