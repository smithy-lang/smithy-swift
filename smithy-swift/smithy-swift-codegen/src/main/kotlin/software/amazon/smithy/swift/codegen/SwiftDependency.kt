...
enum class SwiftDependency(val type: String, val namespace: String, val version: String, val url: String) : SymbolDependencyContainer {
    ...
    CLIENT_RUNTIME("", "ClientRuntime", "0.1.0", "~/Projects/Amplify/SwiftSDK/smithy-swift/smithy-swift/ClientRuntime"),
    XCTest("", "XCTest", "", ""),
    SMITHY_TEST_UTIL("", "SmithyTestUtil", "0.1.0", "~/Projects/Amplify/SwiftSDK/smithy-swift/smithy-swift/ClientRuntime");
