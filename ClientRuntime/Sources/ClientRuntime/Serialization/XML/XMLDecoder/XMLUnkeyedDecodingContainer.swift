...
struct XMLUnkeyedDecodingContainer: UnkeyedDecodingContainer {
    ...
    private mutating func decode<T: Decodable>(
        _ type: T.Type,
        decode: (XMLDecoderImplementation, XMLContainer) throws -> T?
    ) throws -> T {
        ...
        var value: T?
        if let singleKeyed = box as? XMLSimpleKeyBasedContainer {
            do {
    ...
    public mutating func nestedContainer<NestedKey>(
        ...
        guard let keyedContainer = value as? XMLSharedContainer<XMLKeyBasedContainer> else {
    ...
    public mutating func nestedUnkeyedContainer() throws -> UnkeyedDecodingContainer {
        ...
        guard let unkeyedContainer = value as? XMLSharedContainer<XMLArrayBasedContainer> else {
            throw DecodingError.typeMismatch(at: codingPath,
                                             expectation: XMLArrayBasedContainer.self,
                                             reality: value)
        }
