...
//    }
//    
//    public func handle<H>(context: HttpRequestContext, result: Result<SdkHttpRequest, ClientError>, next: H) -> Result<SdkHttpRequest, ClientError> where H: Handler, Self.TError == H.TError, Self.TSubject == H.TSubject {
